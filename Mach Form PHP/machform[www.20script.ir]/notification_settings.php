...
EOT;
	...
	/**CUSTOM_CODE START - Change Machform to Information System*/
	if(empty($esl_from_name)){
		$esl_from_name = 'Information System';
	}

	$esl_from_name_list[0]['label'] = 'Information System';
	$esl_from_name_list[0]['value'] = 'Information System';
	/**CUSTOM_CODE END */
	...
	$esr_from_name_list[0]['label'] = 'Information System';
	$esr_from_name_list[0]['value'] = 'Information System';
	/**CUSTOM_CODE END */
