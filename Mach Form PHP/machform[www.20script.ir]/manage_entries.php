 ...
 ********************************************************************************/	
	...
	$sort_by = isset($_GET['sortby']) ? trim($_GET['sortby']) : false;
	...
	//clear filter if there is "clear_filter" parameter
	if(!empty($_GET['clear_filter'])){
		$query = "delete from `".MF_TABLE_PREFIX."form_filters` where form_id=? and user_id=? and incomplete_entries=0";
				...
				<div class="content_header">
					<div class="content_header_title">
						<div id="me_form_title" <?php if(!empty($total_incomplete_entries)){ echo 'style="max-width: 80%"'; } ?>>
							<h2><?php echo "<a class=\"breadcrumb\" href='manage_forms.php?id={$form_id}'>".$form_name.'</a>'; ?> <span class="icon-arrow-right2 breadcrumb_arrow"></span> Entries</h2>
				...
				<div class="content_body">
					...
					<?php if($form_has_entries){ ?>
						...
						<div id="entries_actions" class="gradient_red">
							...
							<img id="entries_actions_arrow" src="images/icons/29.png" style="position: absolute;left:5px;top:100%" />
						</div>
						...
						<div id="field_selection" style="display: none" class="gradient_blue">
							...
							<span style="position: absolute;right:38px;top:-15px" class="icon-arrow-up pane-arrow-up"></span>
						</div>
						...
						<div id="filter_pane" style="display: none" class="gradient_blue">
							...
							<ul>
								...
								<li id="li_1" class="filter_settings <?php echo $filter_date_class; ?>">
									...
									<span name="conditiontime_1" id="conditiontime_1" class="condition_time" style="<?php echo $condition_time_display; ?>">
										...
										<span class="conditiontime_second" style="<?php echo $condition_second_display; ?>"> : <input name="conditiontimesecond_1" id="conditiontimesecond_1" type="text" class="element text conditiontime_input" maxlength="2" size="2" value="<?php echo $time_second; ?>" placeholder="SS"> </span>
										<select class="element select conditiontime_ampm conditiontime_input" name="conditiontimeampm_1" id="conditiontimeampm_1" style="<?php echo $condition_ampm_display; ?>">
									...
									<a href="#" id="deletefilter_1" class="filter_delete_a"><span class="icon-trash2"></span></a>
								...
								<li id="li_<?php echo $i; ?>" class="filter_settings <?php echo $filter_date_class; ?>">
									...
									<span name="conditiontime_<?php echo $i; ?>" id="conditiontime_<?php echo $i; ?>" class="condition_time" style="<?php echo $condition_time_display; ?>">
										...
										<span class="conditiontime_second" style="<?php echo $condition_second_display; ?>"> : <input name="conditiontimesecond_<?php echo $i; ?>" id="conditiontimesecond_<?php echo $i; ?>" type="text" class="element text conditiontime_input" maxlength="2" size="2" value="<?php echo $time_second; ?>" placeholder="SS"> </span>
							...
							<span style="position: absolute;right:130px;top:-15px" class="icon-arrow-up pane-arrow-up"></span>
						</div>
						...
						<?php 
							...
							//allow the grid to display approval status (when enabled)
							$entries_options['display_approval_status_when_enabled'] = true;
...
<div id="dialog-export-entries" title="Select File Type" class="buttons" style="display: none">
	...
	<ul>
		<li class="gradient_blue"><a id="export_as_excel" href="#" class="export_link">Excel File (.xlsx)</a></li>
...
<div id="dialog-approve-entry" title="Approve Entry" class="buttons" style="display: none"> 
	<form id="dialog-approve-entry-form" class="dialog-form" style="padding-left: 10px;padding-bottom: 10px">	
		<ul id="dialog-approve-entry-li-basic">
			<li>
				<label class="description" for="dialog-approve-entry-note">Add Note (optional)</label>
				<textarea class="element textarea medium" name="dialog-approve-entry-note" id="dialog-approve-entry-note" style="width: 350px; height: 75px"></textarea>
			</li>
		</ul>	
	</form>
</div>
<div id="dialog-deny-entry" title="Deny Entry" class="buttons" style="display: none"> 
	<form id="dialog-deny-entry-form" class="dialog-form" style="padding-left: 10px;padding-bottom: 10px">	
		<ul id="dialog-deny-entry-li-basic">
			<li>
				<label class="description" for="dialog-deny-entry-note">Denial Reason</label>
				<textarea class="element textarea medium" name="dialog-deny-entry-note" id="dialog-deny-entry-note" style="width: 350px; height: 75px"></textarea>
			</li>
		</ul>	
	</form>
</div>
...
<script type="text/javascript" src="js/manage_entries.js{$mf_version_tag}"></script>
EOT;
