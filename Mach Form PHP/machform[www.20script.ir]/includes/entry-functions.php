 ...
 ********************************************************************************/
	...
	function mf_get_entry_values($dbh,$form_id,$entry_id,$use_review_table=false,$options=array()){
		...
		$options['machform_data_path'] = $options['machform_data_path'] ?? '';

		$form_properties = mf_get_form_properties($dbh,$form_id,array('form_encryption_enable','form_encryption_public_key'));
		if(!empty($form_properties['form_encryption_enable']) && !empty($form_properties['form_encryption_public_key'])){
			
			$form_encryption_enable 	 = (int) $form_properties['form_encryption_enable'];
			$form_encryption_public_key  = base64_decode($form_properties['form_encryption_public_key']);

			if(!empty($options['encryption_private_key'])){

				$form_encryption_private_key = base64_decode($options['encryption_private_key']);
				
				try{
					$form_encryption_keypair = \Sodium\crypto_box_keypair_from_secretkey_and_publickey($form_encryption_private_key,$form_encryption_public_key);
				}catch(Error $e){
		...
		while($row = mf_do_fetch_result($sth)){
			...
			$form_elements[$i]['element_is_encrypted'] 			   = $row['element_is_encrypted'];
			$i++;
		}
		...
		foreach ($form_elements as $element){
			...
			//decrypt the data if encryption keypair exist
			if(!empty($form_encryption_keypair) && !empty($element['element_is_encrypted'])){
				try{
					if($element_type == 'simple_name'){
						$entry_data['element_'.$element_id.'_1'] = (empty($entry_data['element_'.$element_id.'_1'])  ? $entry_data['element_'.$element_id.'_1'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_1']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_2'] = (empty($entry_data['element_'.$element_id.'_2'])  ? $entry_data['element_'.$element_id.'_2'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_2']),$form_encryption_keypair));
					}else if($element_type == 'name'){
						$entry_data['element_'.$element_id.'_1'] = (empty($entry_data['element_'.$element_id.'_1'])  ? $entry_data['element_'.$element_id.'_1'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_1']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_2'] = (empty($entry_data['element_'.$element_id.'_2'])  ? $entry_data['element_'.$element_id.'_2'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_2']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_3'] = (empty($entry_data['element_'.$element_id.'_3'])  ? $entry_data['element_'.$element_id.'_3'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_3']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_4'] = (empty($entry_data['element_'.$element_id.'_4'])  ? $entry_data['element_'.$element_id.'_4'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_4']),$form_encryption_keypair));
					}else if($element_type == 'simple_name_wmiddle'){
						$entry_data['element_'.$element_id.'_1'] = (empty($entry_data['element_'.$element_id.'_1'])  ? $entry_data['element_'.$element_id.'_1'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_1']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_2'] = (empty($entry_data['element_'.$element_id.'_2'])  ? $entry_data['element_'.$element_id.'_2'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_2']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_3'] = (empty($entry_data['element_'.$element_id.'_3'])  ? $entry_data['element_'.$element_id.'_3'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_3']),$form_encryption_keypair));
					}else if($element_type == 'name_wmiddle'){
						$entry_data['element_'.$element_id.'_1'] = (empty($entry_data['element_'.$element_id.'_1'])  ? $entry_data['element_'.$element_id.'_1'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_1']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_2'] = (empty($entry_data['element_'.$element_id.'_2'])  ? $entry_data['element_'.$element_id.'_2'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_2']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_3'] = (empty($entry_data['element_'.$element_id.'_3'])  ? $entry_data['element_'.$element_id.'_3'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_3']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_4'] = (empty($entry_data['element_'.$element_id.'_4'])  ? $entry_data['element_'.$element_id.'_4'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_4']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_5'] = (empty($entry_data['element_'.$element_id.'_5'])  ? $entry_data['element_'.$element_id.'_5'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_5']),$form_encryption_keypair));
						...
						$entry_data['element_'.$element_id.'_4'] = (empty($entry_data['element_'.$element_id.'_4'])  ? $entry_data['element_'.$element_id.'_4'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_4']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_5'] = (empty($entry_data['element_'.$element_id.'_5'])  ? $entry_data['element_'.$element_id.'_5'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_5']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_6'] = (empty($entry_data['element_'.$element_id.'_6'])  ? $entry_data['element_'.$element_id.'_6'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_6']),$form_encryption_keypair));
					}else{
						//for other element types (single line text, paragraph, email, phone, simple_phone)
						$entry_data['element_'.$element_id] = (empty($entry_data['element_'.$element_id]) ? $entry_data['element_'.$element_id] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id]),$form_encryption_keypair));
					}
				}catch(Error $e){
					//discard any error, so that we can proceed gracefully
				}catch(Exception $e){
			...
			if('simple_name' == $element_type){ //Simple Name - 2 elements
				...
				if(!empty($filename_array)){
					...
					foreach ($filename_array as $filename_value){
						...
						$filename_value = htmlspecialchars_decode($filename_value,ENT_QUOTES);
	...
	function mf_get_entry_details($dbh,$form_id,$entry_id,$options=array()){
		...
		if(!empty($form_properties['form_encryption_enable']) && !empty($form_properties['form_encryption_public_key'])){
			...
			$hide_encrypted_data = $options['hide_encrypted_data']; // possible values: asterisk,substring
		}
		...
		$show_image_preview  = $options['show_image_preview'] ?? false; //if set to 'true', the uploaded image files will have a preview being displayed
		$hide_password_data  = $options['hide_password_data'] ?? false; //if set to 'true' the data of the password field will be masked with asterisk
		...
		while($row = mf_do_fetch_result($sth)){
			...
			//if this is media field and doesn't have option to be displayed in email, skip it
			if($row['element_type'] == 'media' && empty($row['element_media_display_in_email'])){
				continue;
			}
			...
			$form_elements[$i]['element_is_private'] 	= (int) $row['element_is_private'];
			$form_elements[$i]['element_is_encrypted'] 	= (int) $row['element_is_encrypted'];
			$form_elements[$i]['element_media_type'] 		 = $row['element_media_type'];
			$form_elements[$i]['element_media_image_src'] 	 = $row['element_media_image_src'];
			$form_elements[$i]['element_media_image_width']  = $row['element_media_image_width'];
			$form_elements[$i]['element_media_image_height'] = $row['element_media_image_height'];
			$form_elements[$i]['element_media_image_alt'] 	 = $row['element_media_image_alt'];
			$form_elements[$i]['element_media_image_alignment'] = $row['element_media_image_alignment'];
			$form_elements[$i]['element_rating_style'] 			= $row['element_rating_style'];
			$form_elements[$i]['element_rating_max'] 			= (int) $row['element_rating_max'];
		...
		foreach ($form_elements as $element){
			...
			$element_matrix_allow_multiselect = $element['element_matrix_allow_multiselect'];
			$element_is_private 		= $element['element_is_private'];

			$element_media_type 		= $element['element_media_type'];
			$element_media_image_src 	= $element['element_media_image_src'];
			$element_media_image_width  = $element['element_media_image_width'];
			$element_media_image_height = $element['element_media_image_height'];
			$element_media_image_alt 	= $element['element_media_image_alt'];
			$element_media_image_alignment 	= $element['element_media_image_alignment'];

			$element_rating_style	= $element['element_rating_style'];
			$element_rating_max		= $element['element_rating_max'];
			...
			$entry_details[$i]['element_is_private'] 	= $element_is_private;
			
			$field_is_decrypted = false;
			
			//decrypt the data if encryption keypair exist
			if(!empty($form_encryption_keypair) && empty($options['review_mode']) && !empty($element['element_is_encrypted'])){
				try{
					if($element_type == 'simple_name'){
						$entry_data['element_'.$element_id.'_1'] = (empty($entry_data['element_'.$element_id.'_1'])  ? $entry_data['element_'.$element_id.'_1'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_1']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_2'] = (empty($entry_data['element_'.$element_id.'_2'])  ? $entry_data['element_'.$element_id.'_2'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_2']),$form_encryption_keypair));
						
						$entry_data['element_'.$element_id.'_1'] = htmlspecialchars($entry_data['element_'.$element_id.'_1'],ENT_QUOTES);
						$entry_data['element_'.$element_id.'_2'] = htmlspecialchars($entry_data['element_'.$element_id.'_2'],ENT_QUOTES);
					}else if($element_type == 'name'){
						$entry_data['element_'.$element_id.'_1'] = (empty($entry_data['element_'.$element_id.'_1'])  ? $entry_data['element_'.$element_id.'_1'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_1']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_2'] = (empty($entry_data['element_'.$element_id.'_2'])  ? $entry_data['element_'.$element_id.'_2'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_2']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_3'] = (empty($entry_data['element_'.$element_id.'_3'])  ? $entry_data['element_'.$element_id.'_3'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_3']),$form_encryption_keypair));
						...
						$entry_data['element_'.$element_id.'_1'] = htmlspecialchars($entry_data['element_'.$element_id.'_1'],ENT_QUOTES);
						$entry_data['element_'.$element_id.'_2'] = htmlspecialchars($entry_data['element_'.$element_id.'_2'],ENT_QUOTES);
						$entry_data['element_'.$element_id.'_3'] = htmlspecialchars($entry_data['element_'.$element_id.'_3'],ENT_QUOTES);
						$entry_data['element_'.$element_id.'_4'] = htmlspecialchars($entry_data['element_'.$element_id.'_4'],ENT_QUOTES);
					}else if($element_type == 'simple_name_wmiddle'){
						$entry_data['element_'.$element_id.'_1'] = (empty($entry_data['element_'.$element_id.'_1'])  ? $entry_data['element_'.$element_id.'_1'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_1']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_2'] = (empty($entry_data['element_'.$element_id.'_2'])  ? $entry_data['element_'.$element_id.'_2'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_2']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_3'] = (empty($entry_data['element_'.$element_id.'_3'])  ? $entry_data['element_'.$element_id.'_3'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_3']),$form_encryption_keypair));
						...
						$entry_data['element_'.$element_id.'_3'] = htmlspecialchars($entry_data['element_'.$element_id.'_3'],ENT_QUOTES);
						$entry_data['element_'.$element_id.'_4'] = htmlspecialchars($entry_data['element_'.$element_id.'_4'],ENT_QUOTES);
						$entry_data['element_'.$element_id.'_5'] = htmlspecialchars($entry_data['element_'.$element_id.'_5'],ENT_QUOTES);
					}else if($element_type == 'address'){
						$entry_data['element_'.$element_id.'_1'] = (empty($entry_data['element_'.$element_id.'_1'])  ? $entry_data['element_'.$element_id.'_1'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_1']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_2'] = (empty($entry_data['element_'.$element_id.'_2'])  ? $entry_data['element_'.$element_id.'_2'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_2']),$form_encryption_keypair));
						$entry_data['element_'.$element_id.'_3'] = (empty($entry_data['element_'.$element_id.'_3'])  ? $entry_data['element_'.$element_id.'_3'] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id.'_3']),$form_encryption_keypair));
						...
						$entry_data['element_'.$element_id.'_4'] = htmlspecialchars($entry_data['element_'.$element_id.'_4'],ENT_QUOTES);
						$entry_data['element_'.$element_id.'_5'] = htmlspecialchars($entry_data['element_'.$element_id.'_5'],ENT_QUOTES);
						$entry_data['element_'.$element_id.'_6'] = htmlspecialchars($entry_data['element_'.$element_id.'_6'],ENT_QUOTES);
					}else{
						//for other element types (single line text, paragraph, email, phone, simple_phone)
						$entry_data['element_'.$element_id] = (empty($entry_data['element_'.$element_id]) ? $entry_data['element_'.$element_id] : \Sodium\crypto_box_seal_open(base64_decode($entry_data['element_'.$element_id]),$form_encryption_keypair));
						$entry_data['element_'.$element_id] = htmlspecialchars($entry_data['element_'.$element_id],ENT_QUOTES);
					}
					$field_is_decrypted = true;
				}catch(Error $e){
					//discard any error, so that we can proceed gracefully
				}catch(Exception $e){
					//discard any error, so that we can proceed gracefully
			...
			//if there is parameter to hide encrypted field, alter the data
			if($field_is_decrypted === false && empty($options['review_mode']) && !empty($element['element_is_encrypted']) && !empty($form_encryption_enable)){
				if($element_type == 'simple_name'){
					$merged_encrypted_name_data = '';
					$merged_encrypted_name_data = $entry_data['element_'.$element_id.'_1'].$entry_data['element_'.$element_id.'_2'];

					if(!empty($merged_encrypted_name_data)){
						if($hide_encrypted_data == 'substring'){
							$entry_data['element_'.$element_id.'_1'] = substr($merged_encrypted_name_data,0,40).'...';
							$entry_data['element_'.$element_id.'_2'] = '';
						}else if($hide_encrypted_data == 'asterisk'){
							$entry_data['element_'.$element_id.'_1'] = '**************';
							$entry_data['element_'.$element_id.'_2'] = '';
						}
					}
				}else if($element_type == 'name'){
					$merged_encrypted_name_data = '';
					$merged_encrypted_name_data = $entry_data['element_'.$element_id.'_1'].$entry_data['element_'.$element_id.'_2'].$entry_data['element_'.$element_id.'_3'].$entry_data['element_'.$element_id.'_4'];

					if(!empty($merged_encrypted_name_data)){
						if($hide_encrypted_data == 'substring'){
							$entry_data['element_'.$element_id.'_1'] = substr($merged_encrypted_name_data,0,40).'...';
							$entry_data['element_'.$element_id.'_2'] = '';
							$entry_data['element_'.$element_id.'_3'] = '';
							$entry_data['element_'.$element_id.'_4'] = '';
						}else if($hide_encrypted_data == 'asterisk'){
							$entry_data['element_'.$element_id.'_1'] = '**************';
							$entry_data['element_'.$element_id.'_2'] = '';
							$entry_data['element_'.$element_id.'_3'] = '';
					...
					$merged_encrypted_name_data = '';
					$merged_encrypted_name_data = $entry_data['element_'.$element_id.'_1'].$entry_data['element_'.$element_id.'_2'].$entry_data['element_'.$element_id.'_3'];
					...
					$merged_encrypted_name_data = '';
					$merged_encrypted_name_data = $entry_data['element_'.$element_id.'_1'].$entry_data['element_'.$element_id.'_2'].$entry_data['element_'.$element_id.'_3'].$entry_data['element_'.$element_id.'_4'].$entry_data['element_'.$element_id.'_5'];
					...
					if(!empty($merged_encrypted_name_data)){
						if($hide_encrypted_data == 'substring'){
							...
							$entry_data['element_'.$element_id.'_3'] = '';
							$entry_data['element_'.$element_id.'_4'] = '';
							$entry_data['element_'.$element_id.'_5'] = '';
						}else if($hide_encrypted_data == 'asterisk'){
							$entry_data['element_'.$element_id.'_1'] = '**************';
							$entry_data['element_'.$element_id.'_2'] = '';
							$entry_data['element_'.$element_id.'_3'] = '';
					...
					$merged_encrypted_address_data = '';
					$merged_encrypted_address_data = $entry_data['element_'.$element_id.'_1'].$entry_data['element_'.$element_id.'_2'].$entry_data['element_'.$element_id.'_3'].$entry_data['element_'.$element_id.'_4'].$entry_data['element_'.$element_id.'_5'].$entry_data['element_'.$element_id.'_6'];

					if(!empty($merged_encrypted_address_data)){
						if($hide_encrypted_data == 'substring'){
							$entry_data['element_'.$element_id.'_1'] = substr($merged_encrypted_address_data,0,40).'...';
							$entry_data['element_'.$element_id.'_2'] = '';
							$entry_data['element_'.$element_id.'_3'] = '';
							$entry_data['element_'.$element_id.'_4'] = '';
							$entry_data['element_'.$element_id.'_5'] = '';
							$entry_data['element_'.$element_id.'_6'] = '';
						}else if($hide_encrypted_data == 'asterisk'){
							$entry_data['element_'.$element_id.'_1'] = '**************';
							$entry_data['element_'.$element_id.'_2'] = '';
							$entry_data['element_'.$element_id.'_3'] = '';
					...
					//for field with single column only (text, paragraph, email, phone, simple_phone)
					if(!empty($entry_data['element_'.$element_id])){
						if($hide_encrypted_data == 'substring'){
							$entry_data['element_'.$element_id] = substr($entry_data['element_'.$element_id],0,40).'...';
						}else if($hide_encrypted_data == 'asterisk'){
							$entry_data['element_'.$element_id] = '**************';
						}
					}	
				}	
			}
			...
			if('simple_name' == $element_type){ //Simple Name - 2 elements
				...
				$entry_details[$i]['value'] = $entry_data['element_'.$element_id.'_1'].' '.$entry_data['element_'.$element_id.'_2']."\n".$entry_data['element_'.$element_id.'_3'].' '.$entry_data['element_'.$element_id.'_4'].' '.$entry_data['element_'.$element_id.'_5']."\n".$entry_data['element_'.$element_id.'_6'];
				$entry_details[$i]['value'] = trim($entry_details[$i]['value']);
							...
							if(!empty($options['strip_download_link'])){
								...
								if($show_image_preview === true && $is_image_file){
									if(!empty($options['machform_path'])){ //if the form is called from advanced form code
										$entry_details[$i]['value'] .= '<img src="'.$options['machform_path'].'view_img.php?q='.$q_string.'" style="max-width: 350px;margin: 15px 0;" /><br/><a class="entry_link" href="'.$options['machform_path'].'download.php?q='.$q_string.'">'.$filename_value.'</a><br/>';
									}else{
										$entry_details[$i]['value'] .= '<img src="http'.$ssl_suffix.'://'.$http_host.rtrim(dirname($_SERVER['PHP_SELF']),'/\\').'/view_img.php?q='.$q_string.'" style="max-width: 350px;margin: 15px 0;" /><br/><a class="entry_link" href="http'.$ssl_suffix.'://'.$http_host.rtrim(dirname($_SERVER['PHP_SELF']),'/').'/download.php?q='.$q_string.'">'.$filename_value.'</a><br/>';
									}
								}else{
									if(!empty($options['machform_path'])){ //if the form is called from advanced form code
										$entry_details[$i]['value'] .= '<a class="entry_link" href="'.$options['machform_path'].'download.php?q='.$q_string.'">'.$filename_value.'</a><br/>';
									}else{
										$entry_details[$i]['value'] .= '<a class="entry_link" href="http'.$ssl_suffix.'://'.$http_host.rtrim(dirname($_SERVER['PHP_SELF']),'/\\').'/download.php?q='.$q_string.'">'.$filename_value.'</a><br/>';
									}
								}
							}
			...
			}elseif('media' == $element_type){
				if($element_media_type == 'image'){
					if(!empty($element_guidelines)){
						$entry_details[$i]['value'] = $element_guidelines.'<br/>';
					}

					$entry_details[$i]['value'] .= "<img class=\"media_image\" src=\"{$element_media_image_src}\" width=\"{$element_media_image_width}\" height=\"{$element_media_image_height}\" alt=\"{$element_media_image_alt}\" title=\"{$element_media_image_alt}\" style=\"max-width: 100%;height: auto;margin: 10px 0;\" />";
				}
				...
				if(!empty($element_guidelines) && !empty($element_constraint)){
					...
					$entry_details[$i]['matrix_main_element_id'] = $entry_details[$i]['element_id'];
				...
				//if this is a password field and there is parameter to hide it, then mask it with asterisk
				if($element_constraint == 'password' && $hide_password_data === true){
					$entry_details[$i]['value'] = '**************';
				}
			}else if('rating' == $element_type){
				if(isset($entry_data['element_'.$element_id])){
					$entry_details[$i]['value'] = $entry_data['element_'.$element_id];
					
					$entry_details[$i]['rating_style'] = $element_rating_style;
					$entry_details[$i]['rating_max']   = $element_rating_max;
				}
			}else{ //element with only 1 input
				if(isset($entry_data['element_'.$element_id])){
					$entry_details[$i]['value'] = $entry_data['element_'.$element_id];
	...
	function mf_display_entries_table($dbh,$form_id,$options){
		...
		$display_incomplete_entries 			= $options['display_incomplete_entries'] ?? false;
		$display_approval_status_when_enabled 	= $options['display_approval_status_when_enabled'] ?? false;
		...
		$form_properties = mf_get_form_properties($dbh,$form_id,array('payment_currency','payment_enable_merchant','form_approval_enable'));
		...
		if($display_approval_status_when_enabled === true && $form_approval_enable === true){
		...
		if($form_properties['form_approval_enable'] == 1){
			$column_name_lookup['approval_status'] = 'Approval Status';		
			$column_type_lookup['approval_status'] = 'approval_status';
		}
		...
		while($row = mf_do_fetch_result($sth)){
			...
			if('address' == $element_type){ //address has 6 fields
			...
			}else if('simple_name' == $element_type){ //simple name has 2 fields
			...
			}else if('simple_name_wmiddle' == $element_type){ //simple name with middle has 3 fields
				$column_name_lookup['element_'.$row['element_id'].'_1'] = $row['element_title'].' - First';
			...
			}else if('name' == $element_type){ //name has 4 fields
			...
			}else if('name_wmiddle' == $element_type){ //name with middle has 5 fields
				$column_name_lookup['element_'.$row['element_id'].'_1'] = $row['element_title'].' - Title';
				$column_name_lookup['element_'.$row['element_id'].'_2'] = $row['element_title'].' - First';
			...
			}else if('money' == $element_type){//money format
			...
			}else if('checkbox' == $element_type){ //checkboxes, get childs elements
				...
				$element_rating_lookup['element_'.$row['element_id']]['rating_style'] = $row['element_rating_style']; 
				$element_rating_lookup['element_'.$row['element_id']]['rating_max']   = $row['element_rating_max'];
		...
		if(empty($column_prefs)){
			...
			//if approval is enabled, display only the first 5 fields
			if($show_approval_controls){
				$temp_slice = array_slice($column_name_lookup,0,7);
			}else{
		...
		if($show_approval_controls){
			$column_labels[] = 'mf_approval_status';
		}
				...
				if(in_array($filter_element_type, array('radio','select','matrix_radio'))){
					...
					if($filter_condition == 'is'){
						if(!empty($filter_keyword)){
							...
							$where_clause_array[] = "{$element_name} IS NULL"; 
						}
					...
					if($filter_condition == 'is'){
						...
						$where_operand = '=';
						$where_keyword = "'0'";
					}else if($filter_condition == 'is_approved'){
						$where_operand = '=';
		...
		//if approval enabled, get approvals columns
		$approval_query = '';
		if($show_approval_controls){
			$approval_query = ',`approval_status`,`approval_queue_user_id`';
		}
		...
		//prepend special columns into the column preferences
		if($show_approval_controls){
			array_unshift($column_prefs,"id","row_num","approval_status","approval_queue_user_id");
		}else{
		...
		while($row = mf_do_fetch_result($sth)){
			...
			foreach($column_prefs as $column_name){
				...
				if(!isset($column_type_lookup[$column_name])){
					$column_type_lookup[$column_name] = '';
				}
				
				//limit the data length, unless for file element
				if($column_type_lookup[$column_name] != 'file'){
					if(isset($row[$column_name]) && strlen($row[$column_name]) > $max_data_length){
				...
				if($column_type_lookup[$column_name] == 'time'){
					...
					$column_type = $column_type_temp[1] ?? false;
					...
					if($column_name == 'payment_amount'){
						...
						if(isset($row[$column_name]) && $row[$column_name] == '0.00'){
				...
				}elseif($column_type_lookup[$column_name] == 'rating'){ 
					$form_data[$i][$j] = mf_numeric_to_rating($row[$column_name],$element_rating_lookup[$column_name]['rating_max'],$element_rating_lookup[$column_name]['rating_style']); ;
					...
					if($column_type_lookup[$column_name] == 'radio'){
						$element_radio_has_other['element_'.$this_element_id] = $element_radio_has_other['element_'.$this_element_id] ?? false;
					...
					if(isset($row[$column_name]) && $row[$column_name] == 'paid'){
						$payment_status_color = 'style="color: green;font-weight: bold"';
						$payment_status_label = strtoupper($row[$column_name]);
					}else{
						$payment_status_color = '';
						$payment_status_label = isset($row[$column_name]) ? ucfirst(strtolower($row[$column_name])) : '';
					}

					$form_data[$i][$j] = '<span '.$payment_status_color.'>'.$payment_status_label.'</span>';
				}else{
					$form_data[$i][$j] = isset($row[$column_name]) ? htmlspecialchars(str_replace("\r","",str_replace("\n"," ",$row[$column_name])),ENT_QUOTES) : '';
				}
		...
		foreach($column_labels as $label_name){
			...
			}else if($label_name == 'mf_approval_status'){
				$table_header_markup .= '<th class="me_approval" scope="col">Approval Status</th>'."\n";
			}else{
				...
				foreach ($row_data as $key=>$column_data){
					...
					if($show_approval_controls){
						if($key == 0){ //this is "id" column
							$table_body_markup .= '<td class="me_action"><div><span><input type="checkbox" id="entry_'.$column_data.'" name="entry_'.$column_data.'" value="1" /></span></div></td>'."\n";
						}else if($key == 1){ //this is "row_num" column
							$table_body_markup .= '<td class="me_number"><div><span>'.$column_data.'</span></div></td>'."\n";
						}else if($key == 2){
							
							//display approval controls if enabled and applicable
							$current_row_approval_queue_user_id = $row_data[3];
							$current_row_approval_status		= $column_data;

							if($current_row_approval_status == 'approved'){
								$table_body_markup .=  '<td class="me_approval"><div><span class="icon-circle2" style="color: #77B845;margin-right: 5px"></span> Approved</div></td>'."\n";
							}else if($current_row_approval_status == 'denied'){
								$table_body_markup .=  '<td class="me_approval"><div><span class="icon-circle2" style="color: #dd3a37;margin-right: 5px"></span> Denied</div></td>'."\n";
							}else if($current_row_approval_status == 'pending'){
								
								//if approval status is pending, check if the current user is currently listed within the queue or not
								//if listed, then display the approve/deny button, otherwise simply display 'pending' status
								$current_row_approval_queue_user_id_array = array();
								$current_row_approval_queue_user_id_array = explode("|", $current_row_approval_queue_user_id);
								
								if(in_array($_SESSION['mf_user_id'], $current_row_approval_queue_user_id_array)){
									$table_body_markup .= '<td class="me_approval me_approval_controls">'.
															'<a href="#" id="buttonapprove_'.$row_data[0].'" class="button_approve bb_button bb_small bb_green">Approve</a> '.
															'<a href="#" id="buttondeny_'.$row_data[0].'" class="button_deny bb_button bb_small bb_red">Deny</a>'.
														  '</td>';
								}else{
									$table_body_markup .=  '<td class="me_approval"><div><span class="icon-circle2" style="color: #C1C1C1;margin-right: 5px"></span> Pending</div></td>'."\n";
								}
							}
						}else if($key == 3){
							//skip column 3, which is 'approval_queue_user_id'
							continue;
						}else{
	...
	//similar as mf_get_columns_meta() but won't return the sub-fields detail, only the main field
	function mf_get_simple_columns_meta($dbh,$form_id){

		$column_name_lookup = array();
		$column_type_lookup = array();

		//set column properties for basic fields
		$column_name_lookup['id'] 			= 'Entry No.';
		$column_name_lookup['date_created'] = 'Date Created';
		$column_name_lookup['ip_address'] 	= 'IP Address';
		...
		while($row = mf_do_fetch_result($sth)){
			...
			$column_name_lookup['element_'.$element_id] = $element_title;
			$column_type_lookup['element_'.$element_id] = $element_type;
		}
