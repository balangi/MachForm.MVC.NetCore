					...
					<div id="license_box" data-licensekey="<?php echo $mf_settings['license_key']; ?>" data-machformversion="<?php echo $mf_settings['machform_version']; ?>">
						<table id="license_box_table" width="100%" border="0" cellspacing="0" cellpadding="0">
						  ...
						  <tr>
						    ...
						    <td class="ms_lic_right" width="50%"><span id="lic_customer_id"><?php if(!empty($mf_settings['customer_id'])){echo $mf_settings['customer_id'];}else{echo 'Unlimited';} ?></span></td>
						  </tr>
						  <tr>
						    <td class="ms_lic_left" align="right">Name</td>
						    <td class="ms_lic_right"><span id="lic_customer_name"><?php if(!empty($mf_settings['customer_name'])){echo $mf_settings['customer_name'];}else{echo 'Unlimited';} ?></span> </td>
						  </tr>
						  <tr>
