 ...
 ********************************************************************************/
	...
	/** End data for template variables **/
	...
	while($row = mf_do_fetch_result($sth)){
		...
		$logic_emails_array[$rule_id]['custom_pdf_content'] 	= htmlspecialchars($row['custom_pdf_content'],ENT_QUOTES);
		if(empty($logic_emails_array[$rule_id]['custom_pdf_content'])){
			$logic_emails_array[$rule_id]['custom_pdf_content'] = '{entry_data}';
		}
		...
		if(empty($logic_emails_array[$rule_id]['custom_from_name'])){
			$logic_emails_array[$rule_id]['custom_from_name'] = $mf_settings['default_from_name'];
		}

		if(empty($logic_emails_array[$rule_id]['custom_from_email'])){
			$logic_emails_array[$rule_id]['custom_from_email'] = $mf_settings['default_from_email'];
		}

		if(empty($logic_emails_array[$rule_id]['custom_replyto_email'])){
			$logic_emails_array[$rule_id]['custom_replyto_email'] = $mf_settings['default_from_email'];
		}
	}
	...
	if(empty($logic_emails_array)){
		...
		$logic_emails_array[1]['custom_from_name'] 		= $mf_settings['default_from_name'];
		$logic_emails_array[1]['custom_from_email'] 	= $mf_settings['default_from_email'];
		$logic_emails_array[1]['custom_replyto_email'] 	= $mf_settings['default_from_email'];
		...
		$logic_emails_array[1]['custom_pdf_content'] 	= '{entry_data}';
	...
	$custom_from_name_list[0]['label'] = $mf_settings['default_from_name'];
	$custom_from_name_list[0]['value'] = $mf_settings['default_from_name'];
	...
	$custom_replyto_email_list[0]['label'] = $mf_settings['default_from_email'];
	$custom_replyto_email_list[0]['value'] = $mf_settings['default_from_email'];
...
EOT;
	...
	if(empty($webhook_parameters)){
		...
		foreach ($simple_field_columns_label as $element_name => $element_label) {
			...
			$webhook_parameters[$rule_id][$i]['param_name']  = $param_name;
			$webhook_parameters[$rule_id][$i]['param_value'] = $param_value;
						...
						<li>
							<div id="ls_box_field_rules" class="ns_box_main gradient_blue">
								<div class="ns_box_title">
									...
									<span class="icon-question helpicon" data-tippy-content="Enable this option to show or hide fields on the form based on the value of another fields. Useful for displaying different set of fields based on user choices."></span>
								</div>
															...
															<thead>
																<tr>
																	<td title="Field #<?php echo $element_position; ?> on Page <?php echo $element_page_number; ?>">
																		<strong title="Field #<?php echo $element_position; ?> on Page <?php echo $element_page_number; ?>"><?php echo $element_title; ?></strong><a class="delete_lifieldrule" id="deletelifieldrule_<?php echo $element_id; ?>" href="#"><span class="icon-cross2"></span></a>
																	</td>
																</tr>
															</thead>
															<tbody>
																		...
																		<ul class="ls_field_rules_conditions">
																			...
																			?>
																				...
																				<li id="lifieldrule_<?php echo $element_id.'_'.$i; ?>" <?php echo $condition_date_class; ?>>
																					...
																					<select name="conditionrating_<?php echo $element_id.'_'.$i; ?>" id="conditionrating_<?php echo $element_id.'_'.$i; ?>" class="element select condition_rating" style="width: 120px;<?php echo $condition_rating_display; ?>">
																						<option <?php if($value['rule_condition'] == 'is'){ echo 'selected="selected"'; } ?> value="is">Is</option>
																						<option <?php if($value['rule_condition'] == 'is_not'){ echo 'selected="selected"'; } ?> value="is_not">Is Not</option>
																						<option <?php if($value['rule_condition'] == 'less_than'){ echo 'selected="selected"'; } ?> value="less_than">Less than</option>
																						<option <?php if($value['rule_condition'] == 'greater_than'){ echo 'selected="selected"'; } ?> value="greater_than">Greater than</option>
																					...
																					<select id="conditionratingvalues_<?php echo $element_id.'_'.$i; ?>" name="conditionratingvalues_<?php echo $element_id.'_'.$i; ?>" autocomplete="off" class="element select condition_ratingvalues" style="<?php echo $condition_ratingvalues_display; ?>">
																						<?php
																					...
																					<a href="#" id="deletecondition_<?php echo $element_id.'_'.$i; ?>" name="deletecondition_<?php echo $element_id.'_'.$i; ?>" class="a_delete_condition"><span class="icon-minus-circle2"></span></a>
																				</li>
																			...
																			<li class="ls_add_condition">
																				<a href="#" id="addcondition_<?php echo $element_id; ?>" class="a_add_condition"><span class="icon-plus-circle"></span></a>
																			</li>
																		</ul>
																	</td>
																</tr>
						...
						<li>
							<div id="ls_box_page_rules" class="ns_box_main gradient_red">
								<div class="ns_box_title">
									...
									<span class="icon-question helpicon" data-tippy-content="Enable this option to allow users to jump into the success page or go to any specific page based on their choices. Useful when you have multipage form and need to display different set of pages based on user choices."></span>
								</div>
													...
													<li id="lipagerule_<?php echo $page_id; ?>">
														<table width="100%" cellspacing="0">
															<thead>
																<tr>
																	<td>
																		<strong><?php echo $page_title; ?></strong><a class="delete_lipagerule" id="deletelipagerule_<?php echo $page_id; ?>" href="#"><span class="icon-cross2"></span></a>
																	</td>
																</tr>
															</thead>
															<tbody>
																		...
																		<ul class="ls_page_rules_conditions">
																			...
																			?>
																				...
																				<li id="lipagerule_<?php echo $page_id.'_'.$i; ?>" <?php echo $condition_date_class; ?>>
																					...
																					<select name="conditionrating_<?php echo $page_id.'_'.$i; ?>" id="conditionrating_<?php echo $page_id.'_'.$i; ?>" class="element select condition_rating" style="width: 120px;<?php echo $condition_rating_display; ?>">
																						<option <?php if($value['rule_condition'] == 'is'){ echo 'selected="selected"'; } ?> value="is">Is</option>
																						<option <?php if($value['rule_condition'] == 'is_not'){ echo 'selected="selected"'; } ?> value="is_not">Is Not</option>
																						<option <?php if($value['rule_condition'] == 'less_than'){ echo 'selected="selected"'; } ?> value="less_than">Less than</option>
																						<option <?php if($value['rule_condition'] == 'greater_than'){ echo 'selected="selected"'; } ?> value="greater_than">Greater than</option>
																					...
																					<select id="conditionratingvalues_<?php echo $page_id.'_'.$i; ?>" name="conditionratingvalues_<?php echo $page_id.'_'.$i; ?>" autocomplete="off" class="element select condition_ratingvalues" style="<?php echo $condition_ratingvalues_display; ?>">
																						<?php
																					...
																					<a href="#" id="deletecondition_<?php echo $page_id.'_'.$i; ?>" name="deletecondition_<?php echo $page_id.'_'.$i; ?>" class="a_delete_condition"><span class="icon-minus-circle2"></span></a>
																				</li>
																			...
																			<li class="ls_add_condition">
																				<a href="#" id="addcondition_<?php echo $page_id; ?>" class="a_add_condition"><span class="icon-plus-circle"></span></a>
																			</li>
																		</ul>
																	</td>
																</tr>
						...
						<li>
							<div id="ls_box_email_rules" class="ns_box_main gradient_green">
								<div class="ns_box_title">
									...
									<span class="icon-question helpicon" data-tippy-content="Enable this option to send additional notification emails to any email address based on user choices. You can customize the email content, subject, and from address based on user choices."></span>
								</div>
								<div class="ls_box_content" <?php if(empty($logic_email_enable)){ echo 'style="display: none"'; } ?>>									
									<ul id="ls_email_rules_group">
										<?php
											foreach ($logic_emails_array as $rule_id => $value) {
												...
												$rule_properties->custom_pdf_content 	= htmlspecialchars_decode($value['custom_pdf_content'],ENT_QUOTES);
												...
												<li id="liemailrule_<?php echo $rule_id; ?>">
														<table width="100%" cellspacing="0">
															<thead>
																<tr>
																	<td>
																		<strong class="rule_title">Rule #<?php echo $rule_properties->rule_id; ?></strong><a class="delete_liemailrule" id="deleteliemailrule_<?php echo $rule_id; ?>" href="#"><span class="icon-cross2"></span></a>
																	</td>
																</tr>
															</thead>
															<tbody>
																<tr>
																	<td>
																		...
																		<ul class="ls_email_rules_conditions">
																			...
																			<?php
																				...
																				foreach ($current_element_conditions as $value) {
																					...
																					//special conditions
																					if($condition_element_name == 'approval_status'){
																						$field_element_type = 'approval_status';
																					}

																					if($condition_element_name == 'form_is_submitted'){
																						$field_element_type = 'form_is_submitted';
																					}
																					...
																					if(in_array($field_element_type, array('money','number'))){
																						...
																						$condition_rating_display = 'display:none';
																						$condition_ratingvalues_display = 'display:none';
																					}else if($field_element_type == 'form_is_submitted'){
																						$condition_text_display = 'display:none';
																						$condition_number_display = 'display:none';
																						$condition_date_display = 'display:none';
																						$condition_time_display = 'display:none';
																				...
																				<li id="liemailrule_<?php echo $rule_id.'_'.$i; ?>" <?php echo $condition_date_class; ?>>
																					<select id="conditionemail_<?php echo $rule_id.'_'.$i; ?>" name="conditionemail_<?php echo $rule_id.'_'.$i; ?>" autocomplete="off" class="element select condition_fieldname" style="width: 260px;">
																						...
																						<?php
																							...
																							//display "form is submitted" special option
																							if($condition_element_name == 'form_is_submitted'){
																								$selected_tag = 'selected="selected"';
																							}else{
																								$selected_tag = '';
																							...
																							echo "<option {$selected_tag} value=\"form_is_submitted\">-- Form Is Submitted --</option>\n";
																							...
																							if(!empty($form_approval_enable)){
																								...
																								echo '<optgroup label="Approval Workflow">'.
																										"<option {$selected_tag} value=\"approval_status\">Final Approval Status</option>".
																									 '</optgroup>';
																							}
																						?>
																					...
																					<select name="conditionrating_<?php echo $rule_id.'_'.$i; ?>" id="conditionrating_<?php echo $rule_id.'_'.$i; ?>" class="element select condition_rating" style="width: 120px;<?php echo $condition_rating_display; ?>">
																						<option <?php if($value['rule_condition'] == 'is'){ echo 'selected="selected"'; } ?> value="is">Is</option>
																						<option <?php if($value['rule_condition'] == 'is_not'){ echo 'selected="selected"'; } ?> value="is_not">Is Not</option>
																						<option <?php if($value['rule_condition'] == 'less_than'){ echo 'selected="selected"'; } ?> value="less_than">Less than</option>
																						<option <?php if($value['rule_condition'] == 'greater_than'){ echo 'selected="selected"'; } ?> value="greater_than">Greater than</option>
																					...
																					<select name="conditionapprovalstatus_<?php echo $rule_id.'_'.$i; ?>" id="conditionapprovalstatus_<?php echo $rule_id.'_'.$i; ?>" class="element select condition_approval_status" style="width: 120px;<?php echo $condition_approval_status_display; ?>">
																					...
																					<select id="conditionratingvalues_<?php echo $rule_id.'_'.$i; ?>" name="conditionratingvalues_<?php echo $rule_id.'_'.$i; ?>" autocomplete="off" class="element select condition_ratingvalues" style="<?php echo $condition_ratingvalues_display; ?>">
																						<?php
																					...
																					<a href="#" id="deletecondition_<?php echo $rule_id.'_'.$i; ?>" name="deletecondition_<?php echo $rule_id.'_'.$i; ?>" class="a_delete_condition"><span class="icon-minus-circle2"></span></a>
																				</li>
																			...
																			<li class="ls_add_condition">
																				<a href="#" id="addcondition_<?php echo $rule_id; ?>" class="a_add_condition"><span class="icon-plus-circle"></span></a>
																			</li>
																		</ul>
																		<h6>
																			<span class="icon-arrow-right1"></span> Send email to: 
																		...
																		<h6 style="margin-bottom: 0px;padding-bottom: 2px">
																			<span class="icon-arrow-right1"></span> Using email template:  
																		...
																		<?php if(!empty($payment_enable_merchant) && $payment_merchant_type != 'check'){ ?>
																			<div class="ls_email_rules_delay_notification" id="ls_email_rules_delay_notification_div_<?php echo $rule_id; ?>" <?php if($rule_properties->template_name == 'custom'){ echo 'style="display: none"'; } ?>>
																				...
																				<label for="emaildelaynotification_<?php echo $rule_id; ?>">Delay Notification Until Paid</label> 	
																				<span class="icon-question helpicon" data-tippy-content="If enabled, notification email will only being sent when payment is made successfully."></span>
																			</div>
																		<?php } ?>
																		...
																		<div class="ls_email_rules_custom_template" id="ls_email_custom_template_div_<?php echo $rule_id; ?>" <?php if($rule_properties->template_name != 'custom'){ echo 'style="display: none"'; } ?>>
																			...
																			<div class="ls_email_rules_custom_template_body">
																				<label class="description inline" for="customfromname_<?php echo $rule_id; ?>">From Name </label>
																				...
																				<label class="description inline" for="customreplytoemail_<?php echo $rule_id; ?>">Reply-To Email </label>
																				...
																				<label class="description inline" for="customfromemail_<?php echo $rule_id; ?>">From Email </label>
																				...
																				<label class="description inline" for="customemailbcc_<?php echo $rule_id; ?>">Bcc </label>
																				...
																				<label class="description inline" for="customemailcontent_<?php echo $rule_id; ?>">Email Content </label>
																				...
																				<div id="divpdfcontent_<?php echo $rule_id; ?>" style="display: <?php if(!empty($rule_properties->custom_pdf_enable)){ echo 'block'; }else{ echo 'none'; } ?>">
																					<label class="description inline" for="custompdfcontent_<?php echo $rule_id; ?>">PDF Content </label>
																					<span class="icon-question helpicon" data-tippy-content="This field accept HTML codes and merge tags."></span>
																					<textarea class="element textarea medium custom_pdf_content" name="custompdfcontent_<?php echo $rule_id; ?>" id="custompdfcontent_<?php echo $rule_id; ?>"><?php echo $rule_properties->custom_pdf_content; ?></textarea>
																				</div>
																				...
																				<?php if(!empty($payment_enable_merchant) && $payment_merchant_type != 'check'){ ?>
																					<span style="display: block;margin-top: 10px">
																						...
																						<label class="inline" for="customemaildelaynotification_<?php echo $rule_id; ?>">Delay Notification Until Paid</label> 	
																						<span class="icon-question helpicon clearfix" data-tippy-content="If enabled, notification email will only being sent when payment is made successfully."></span>
																					</span>
																				<?php } ?>

																				<span class="ns_temp_vars"><span class="icon-info helpicon" style="vertical-align: top;margin-right: 5px"></span> You can insert <a href="#" class="tempvar_link">merge tags</a> into Email Subject, Email Content and PDF Content.</span>
																			</div> 
																		</div>
									...
									<div id="ls_email_add_rule_div">
										<a id="ls_add_email_rule" href="#"><span class="icon-plus-circle"></span> Add Email Rule</a>
									</div>
								</div>
						...
						<li>
							<div id="ls_box_webhook_rules" class="ns_box_main gradient_green">
								<div class="ns_box_title">
									...
									<span class="icon-question helpicon" data-tippy-content="This is ADVANCED option. Enable this option to send additional webhooks to any other URLs based on user choices."></span>
								</div>
								<div class="ls_box_content" <?php if(empty($logic_webhook_enable)){ echo 'style="display: none"'; } ?>>									
									<ul id="ls_webhook_rules_group">
										<?php
											foreach ($logic_webhooks_array as $rule_id => $value) {
												...
												$rule_properties->rule_id 	   				= $rule_id;
												$rule_properties->rule_all_any 				= $value['rule_all_any'];
												$rule_properties->webhook_url 				= isset($value['webhook_url']) ? htmlspecialchars_decode($value['webhook_url'],ENT_QUOTES) : '';
												$rule_properties->webhook_method 			= isset($value['webhook_method']) ? $value['webhook_method'] : '';
												$rule_properties->webhook_format 			= isset($value['webhook_format']) ? $value['webhook_format'] : '';
												$rule_properties->webhook_raw_data 			= isset($value['webhook_raw_data']) ? htmlspecialchars_decode($value['webhook_raw_data'],ENT_QUOTES) : '';
												$rule_properties->webhook_enable_http_auth 	= isset($value['webhook_enable_http_auth']) ? $value['webhook_enable_http_auth'] : false;
												$rule_properties->webhook_http_username 	= isset($value['webhook_http_username']) ? htmlspecialchars_decode($value['webhook_http_username'],ENT_QUOTES) : '';
												$rule_properties->webhook_http_password 	= isset($value['webhook_http_password']) ? htmlspecialchars_decode($value['webhook_http_password'],ENT_QUOTES) : '';
												$rule_properties->webhook_enable_custom_http_headers = $value['webhook_enable_custom_http_headers'] ?? false;
												$rule_properties->webhook_custom_http_headers 		 = isset($value['webhook_custom_http_headers']) ? htmlspecialchars_decode($value['webhook_custom_http_headers'],ENT_QUOTES) : '';
												$rule_properties->delay_notification_until_paid		 = $value['delay_notification_until_paid'] ?? false;
												...
												<li id="liwebhookrule_<?php echo $rule_id; ?>">
														<table width="100%" cellspacing="0">
															<thead>
																<tr>
																	<td>
																		<strong class="rule_title">Rule #<?php echo $rule_properties->rule_id; ?></strong><a class="delete_liwebhookrule" id="deleteliwebhookrule_<?php echo $rule_id; ?>" href="#"><span class="icon-cross2"></span></a>
																	</td>
																</tr>
															</thead>
															<tbody>
																<tr>
																	<td>
																		...
																		<h6>
																			<span class="icon-arrow-right1"></span> Send form data to URL: 
																		...
																		<h6 style="margin-bottom: 0px;padding-bottom: 2px">
																			<span class="icon-arrow-right1"></span> Using the following settings:  
																		</h6>
																		<div class="ls_webhook_options" id="ls_webhook_options_div_<?php echo $rule_id; ?>">
																			...
																			<div class="ls_webhook_options_body">
																				...
																				<div class="webhook_http_header_div" id="webhook_http_header_div_<?php echo $rule_id; ?>" <?php if(empty($rule_properties->webhook_enable_custom_http_headers)){ echo 'style="display: none"'; } ?>>
																					<label class="description inline" style="margin-top: 10px" for="webhookcustomhttpheaders_<?php echo $rule_id; ?>">HTTP Headers </label>
																					<span class="icon-question helpicon clearfix" data-tippy-content="A JSON object of all HTTP Headers you need to send."></span>
																				...
																				<?php if(!empty($payment_enable_merchant) && $payment_merchant_type != 'check'){ ?>
																					<span style="display: block;margin-top: 10px">
																						...
																						<label class="inline" for="webhookdelaynotification_<?php echo $rule_id; ?>">Delay Notification Until Paid</label>  	
																						<span class="icon-question helpicon clearfix" data-tippy-content="If enabled, webhook will only being sent when payment is made successfully."></span>
																					</span>
																				<?php } ?>
																				...
																				<div class="webhook_raw_div" id="webhook_raw_div_<?php echo $rule_id; ?>" <?php if($rule_properties->webhook_format == 'key-value'){ echo 'style="display: none"'; } ?>>
																					<label class="description inline" style="border-bottom: 1px dashed #97BF6B;padding-bottom: 10px;margin-bottom: 15px">Raw Data </label>
																					<span class="icon-question helpicon clearfix" data-tippy-content="Enter any content you would like to send here. You can use any data format (e.g. JSON, XML or raw text). Just make sure to set the proper 'Content-Type' HTTP header as well."></span>
																				...
																				<div class="webhook_parameters_label_div" <?php if($rule_properties->webhook_format == 'raw'){ echo 'style="display: none"'; } ?>>
																					<label id="webhook_parameters_label_<?php echo $rule_id; ?>" class="description inline webhook_parameters_label" style="border-bottom: 1px dashed #97BF6B;padding-bottom: 10px">Parameters </label>
																					<span class="icon-question helpicon clearfix" data-tippy-content="Name -> You can type any parameter name you prefer here. <br/><br/>Value -> Should be the merge tag of the field you would like to send. Such as {element_1} or {element_2} etc. You can also enter any static value."></span>
																				</div>
																					...
																					?>	
																						<li class="ns_url_params">
																							...
																							<div class="ns_param_control">
																								<a class="delete_webhook_param" name="deletewebhookparam_<?php echo $clean_rule_id.'_'.$i; ?>" id="deletewebhookparam_<?php echo $clean_rule_id.'_'.$i; ?>" href="#"><span class="icon-minus-circle2"></span></a>
																							</div>
																						</li>
																					<?php $i++;} ?>
																					
																					<li class="ns_url_add_param" style="padding-bottom: 0px;text-align: right; border-top: 1px dashed #97BF6B;padding-top: 10px">
																						<a class="add_webhook_param" id="addwebhookparam_<?php echo $clean_rule_id; ?>" href="#"><span class="icon-plus-circle"></span></a>
																					</li>
																				</ul>
																				
		
																				<span class="ns_temp_vars"><span class="icon-info helpicon" style="vertical-align: top;margin-right: 5px"></span> You can insert <a href="#" class="tempvar_link">merge tags</a> into parameter values or data.</span>
																			</div> 
																		</div>
																	</td>
																</tr>
									...
									<div id="ls_webhook_add_rule_div">
										<a id="ls_add_webhook_rule" href="#"><span class="icon-plus-circle"></span> Add Webhook Rule</a>
									</div>
								</div>
						...
						<li>
							<div id="ls_box_success_rules" class="ns_box_main gradient_green">
								<div class="ns_box_title">
									...
									<span class="icon-question helpicon" data-tippy-content="Enable this option to display custom success page or redirect to any custom URL based on user choices. This will override your default form success page."></span>
								</div>
								<div class="ls_box_content" <?php if(empty($logic_success_enable)){ echo 'style="display: none"'; } ?>>									
									<ul id="ls_success_rules_group">
										<?php
											foreach ($logic_success_array as $rule_id => $value) {
												...
												$rule_properties->redirect_url 				= isset($value['redirect_url']) ? htmlspecialchars_decode($value['redirect_url'],ENT_QUOTES) : '';
												$rule_properties->success_message 			= isset($value['success_message']) ? htmlspecialchars_decode($value['success_message'],ENT_QUOTES) : '';
												...
												<li id="lisuccessrule_<?php echo $rule_id; ?>">
														<table width="100%" cellspacing="0">
															<thead>
																<tr>
																	<td>
																		<strong class="rule_title">Rule #<?php echo $rule_properties->rule_id; ?></strong><a class="delete_lisuccessrule" id="deletelisuccessrule_<?php echo $rule_id; ?>" href="#"><span class="icon-cross2"></span></a>
																	</td>
																</tr>
															</thead>
															<tbody>
																<tr>
																	<td>
																		...
																		<h6 style="float: left;margin-right: 10px;margin-bottom: 0px;">
																			<span class="icon-arrow-right1"></span> On Success Page: 
																		</h6>	
																		<div style="float: left">	
																			<span>
																		...
																		<span class="ns_temp_vars" style="margin-left: 35px"><span class="icon-info helpicon" style="vertical-align: top;margin-right: 5px"></span> You can insert <a href="#" class="tempvar_link">merge tags</a> into Success Message or Redirect URL.</span>
																	</td>
																</tr>
															</tbody>
														</table>
									...
									<div id="ls_success_add_rule_div">
										<a id="ls_add_success_rule" href="#"><span class="icon-plus-circle"></span> Add Success Page Rule</a>
									</div>
								</div>
...
<script type="text/javascript" src="js/logic_settings.js{$mf_version_tag}"></script>
<style>
.tippy-tooltip{
	font-size: 98%;
}
